...
services:
  custom-api-mcp:
    ...
    volumes:
      ...
      - ./logs:/app/logs
    healthcheck:
      test: ["CMD", "curl", "-f", "https://quantrelbackend-3.lemonplant-1fe15edf.westus2.azurecontainerapps.io/health"]
      interval: 30s
      timeout: 10s
      retries: 3
...
HEALTHCHECK --interval=30s --timeout=10s --start-period=5s --retries=3 \
  CMD curl -f https://quantrelbackend-3.lemonplant-1fe15edf.westus2.azurecontainerapps.io/health || exit 1
